...
// Check if the player value exist in the choices[]
...
if (in_array($player, $choices))
{
    ...
    if ($checker == 1)
        ...
        echo "It's a tie! The computer also chose " . $computer . "!\n";
    else
        echo "Sorry, you lost. The computer chose " . $computer . "!\n";
}
else
    echo "Por favor, escolha uma palavra entre \"rock\", \"paper\" ou \"scissor\" em letras minúsculas!";
?>
